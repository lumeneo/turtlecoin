...
//kodiak loves guppy in a heterosexual way :)
...
/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in Lumeneod. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1533004799;
...
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 82000;
...
const char     LATEST_VERSION_URL[]                          = "https://lumeneo.network/";
